...
#-------------------------------------------------------------------
box1=Label(bg="#1E136E", width="40", height="22")
...
cerrar_camara_inferior = Button(myWindow, text = "Cerrar Camara", width="28", bg="#B6ADE4")
cerrar_camara_inferior.place(x=40, y=420)

#-------------------------------------------------------------------
#      Box_2: Cámara Superior
#-------------------------------------------------------------------
box2=Label(bg="#1E136E", width="40", height="22")
...
cerrar_camara_superior = Button(myWindow, text = "Cerrar Camara", width="28", bg="#B6ADE4")
cerrar_camara_superior.place(x=340, y=420)

#-------------------------------------------------------------------
#      Box_3: ...
#-------------------------------------------------------------------
box3=Label(bg="#1E136E", width="40", height="22")
